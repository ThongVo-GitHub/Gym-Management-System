...
const AppLayoutUser = () => {
  ...
  return (
    <div className="flex min-h-screen relative">
      {/* Gym background */}
      <div
        className="gym-bg absolute inset-0 z-0"
        style={{
          backgroundImage:
            "linear-gradient(135deg, hsla(359, 65%, 35%, 0.08) 0%, hsla(280, 60%, 40%, 0.06) 100%)",
      ...
      <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, hsla(359, 65%, 45%, 0.18) 0%, transparent 70%)",
            top: "10%",
            left: "5%",
          }}
        />
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, hsla(359, 55%, 42%, 0.14) 0%, transparent 70%)",
            top: "60%",
            right: "5%",
          }}
        />
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, hsla(359, 60%, 35%, 0.12) 0%, transparent 70%)",
            bottom: "5%",
            left: "40%",
          }}
        />
