...
const navItems = [
  { to: "/member-dashboard", label: "Tổng quan", icon: LayoutDashboard },
  { to: "/member-packages", label: "Gói hội viên", icon: CreditCard },
  { to: "/member-booking", label: "Đặt lịch tập", icon: CalendarPlus },
  { to: "/checkin", label: "Điểm danh", icon: ScanLine },
  { to: "/member-schedule", label: "Lịch của tôi", icon: Calendar },
