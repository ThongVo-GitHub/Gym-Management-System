    ...
    <div className="p-6 lg:p-8 max-w-6xl mx-auto space-y-6">
      ...
      <div className="glass-card p-6 animate-scale-up" style={{ animationDelay: '250ms' }}>
        <div className="grid grid-cols-3 gap-6">
          <StatCounter end={5} label="Lớp học nhóm" icon={Dumbbell} color="200, 70%, 50%" />
          <StatCounter end={25} label="Slot trống" icon={TrendingUp} color="152, 60%, 48%" />
          <StatCounter end={5} label="Huấn luyện viên" icon={Users} color="280, 60%, 55%" />
        </div>
      </div>
